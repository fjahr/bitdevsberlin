...
[Meetup](https://www.meetup.com/bitcoin-lab-berlin/events/298337252/)
...
- [Graph Visualization for Blockchain Data](https://arxiv.org/abs/2403.03504)
- [Partial Pre-Image Attack on Proof-of-Work based Blockchains](https://www.sciencedirect.com/science/article/pii/S2096720924000071)
...
- [High-Bandwidth Node Selection in Compact Block Relay](https://ipsj.ixsq.nii.ac.jp/ej/?action=pages_view_main&active_action=repository_view_main_item_detail&item_id=233032&item_no=1&page_id=13&block_id=8)
...
- [On the Dark Side of the Coin: Characterizing Bitcoin use for Illicit Activities](https://www.ida.liu.se/~nikca89/papers/pam24a.pdf)
- [HARTS: High-Threshold, Adaptively Secure, and Robust Threshold Schnorr Signatures](https://eprint.iacr.org/2024/280)
- [Bitcoin adoption in online payments: examining consumer intentions and word-of-mouth recommendations](https://link.springer.com/article/10.1186/s43093-024-00313-9)
...
- [OpenSats: Long term funding for Nostr devs](https://opensats.org/blog/nostr-lts-long-term-support-for-nostr-developers)
...
- [Deutsche Börse Digital Exchange](https://www.deutsche-boerse-cash-market.com/dbcm-de/secondary-market/dbdx)
- [Bitcoin Governance: Wer hat die Macht beim Bitcoin?](https://www.golem.de/news/bitcoin-governance-wer-hat-die-macht-beim-bitcoin-2403-182591.html)

## Mailing Lists

### bitcoin-dev

- [Adding New BIP Editors](https://groups.google.com/g/bitcoindev/c/cuMZ77KEQAA/m/vUd1mh9kAgAJ?pli=1)
...
- [ASMap creation process](https://delvingbitcoin.org/t/asmap-creation-process/548)
...
- [Op_inout_amount](https://delvingbitcoin.org/t/op-inout-amount/549)
- [Dual Funding BOLT merged](https://github.com/lightning/bolts/issues/851)
- [OP_VAULT BIP merged](https://github.com/bitcoin/bips/pull/1421)

### Bitcoin Core

- [Voting on Priority Projects for 28.0 #29465](https://github.com/bitcoin/bitcoin/issues/29465)
- [wallet: Add CoinGrinder coin selection algorithm #27877](https://github.com/bitcoin/bitcoin/pull/27877)
- [p2p: Don't process mutated blocks #29412](https://github.com/bitcoin/bitcoin/pull/29412)

### LND

- [lnwire: add new closing_complete and closing_sig messages #8338](https://github.com/lightningnetwork/lnd/pull/8338)

### Eclair

- [Abandon transactions whose ancestors have been double spent #2818](https://github.com/ACINQ/eclair/pull/2818)
- [Activate dual funding by default #2825](https://github.com/ACINQ/eclair/pull/2825)
- [Allow plugins to set a dual funding contribution #2829](https://github.com/ACINQ/eclair/pull/2829)

### BDK & LDK

- [Preliminary refactoring & structure for dual-funded channels #2770](https://github.com/lightningdevkit/rust-lightning/pull/2770)

### Core Lightning

- [Anchors not experimental #6785](https://github.com/ElementsProject/lightning/pull/6785)
